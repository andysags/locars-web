    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      <main className="mx-auto max-w-6xl px-6 md:px-12 py-16 md:py-24">
        ...
        <div className="grid gap-6 lg:grid-cols-3 lg:items-stretch">
          <section className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl shadow-black/20 backdrop-blur-sm lg:col-span-2 lg:h-full">
          ...
          <div className="flex flex-col gap-6 lg:h-full lg:justify-between">
            <section className="rounded-[2rem] border border-white/10 bg-white/5 p-5 shadow-sm backdrop-blur-sm">
              <h3 className="text-lg font-semibold text-white mb-2">Notre mission</h3>
              <p className="text-slate-300 leading-relaxed">
            ...
            <section className="rounded-[2rem] border border-white/10 bg-white/5 px-5 py-4 shadow-sm backdrop-blur-sm">
              <h3 className="text-lg font-semibold text-white mb-2">Nos valeurs</h3>
            ...
            <section className="rounded-[2rem] border border-white/10 bg-white/5 p-5 shadow-sm backdrop-blur-sm">
              <h3 className="text-lg font-semibold text-white mb-3">Notre vision</h3>
              <p className="text-slate-300 leading-relaxed">
